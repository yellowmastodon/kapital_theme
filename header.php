    ...
    <div class="horizontal-nav-wrapper position-sticky">
        ...
        if ($is_woocommerce_site) {
            ...
            if (!is_cart()  && !is_checkout()):
                ...
                <div class="kapital-cart-link position-relative">
                    <a class="btn btn-outline rounded-pill" href="<?=wc_get_cart_url()?>">
                        ...
                        <span class="kapital-cart-quantity-mini-badge rounded-pill text-white bg-red position-absolute" style="display: <?=$cart_contents > 0 ? "inline-block" : "none"?>">
                        <?= $cart_contents > 0 ? $cart_contents : ''?>
                        </span>
                    </a>
                </div>
