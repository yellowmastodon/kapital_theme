...
/* harmony import */ var _ajax_request__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ajax-request */ "./assets/scripts/ajax-request.js");
/* harmony import */ var _post_filter_modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./post-filter-modal */ "./assets/scripts/post-filter-modal.js");
/* harmony import */ var _show_more_posts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./show-more-posts */ "./assets/scripts/show-more-posts.js");
/* harmony import */ var _donation_form__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./donation-form */ "./assets/scripts/donation-form.js");
/* harmony import */ var _product_carousel__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./product-carousel */ "./assets/scripts/product-carousel.js");
...
(0,_show_more_posts__WEBPACK_IMPORTED_MODULE_7__["default"])();
if (document.body.classList.contains('single-product')) {
  (0,_product_carousel__WEBPACK_IMPORTED_MODULE_9__["default"])();
}
var donation_form_wrapper = document.getElementById("darujme-form-wrapper");
if (donation_form_wrapper) {
  (0,_donation_form__WEBPACK_IMPORTED_MODULE_8__["default"])(donation_form_wrapper);
}
...
(0,_post_filter_modal__WEBPACK_IMPORTED_MODULE_6__["default"])();
...
if (!document.body.classList.contains('woocommerce-active')) {
  if (isSinglePostOrPodcast) {
    if (AdInsertingEnabled || DonationInsertingEnabled) {
      (0,_ajax_request__WEBPACK_IMPORTED_MODULE_5__["default"])('adinserter', {
        onead: true,
        ad: AdInsertingEnabled,
        donation: DonationInsertingEnabled
      }, _ad_inserter__WEBPACK_IMPORTED_MODULE_4__.adInserter, [true, _ajax_request__WEBPACK_IMPORTED_MODULE_5__["default"]]);
    }
  } else {
    (0,_ajax_request__WEBPACK_IMPORTED_MODULE_5__["default"])('adinserter', {
      onead: false,
      ad: AdInsertingEnabled,
      donation: false
    }, _ad_inserter__WEBPACK_IMPORTED_MODULE_4__.adInserter, [false, _ajax_request__WEBPACK_IMPORTED_MODULE_5__["default"]]);
  }
}
...
addEventListener("DOMContentLoaded", function () {
  if (_typeof(postViewsElements) !== undefined) {
    ...
    for (var i = 0; i < postViewsElements.length; i += 8) {
      ...
      (0,_ajax_request__WEBPACK_IMPORTED_MODULE_5__["default"])('getviews', {
        ids: postIdsBatch
