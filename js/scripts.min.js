...
/* harmony export */   checkAdInsertingEnabledSinglePost: () => (/* binding */ checkAdInsertingEnabledSinglePost),
/* harmony export */   checkSinglePost: () => (/* binding */ checkSinglePost),
 ...
 */
function adInserter(adHTML) {
  var isSinglePost = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  var registerClicksCallback = arguments.length > 2 ? arguments[2] : undefined;
  var paragraphs = document.querySelectorAll("#post-content > p");
  if (paragraphs.length > 8) {
    var adPosition = Math.floor((paragraphs.length - 1) / 3);
    paragraphs[adPosition].insertAdjacentHTML('afterend', adHTML);
  } else if (paragraphs.length > 3) {
    console.log(paragraphs);
    var _adPosition = Math.floor((paragraphs.length - 1) / 2);
    paragraphs[_adPosition].insertAdjacentHTML('afterend', adHTML);
  }
...
function registerClicks(elements) {
  ...
  function onClick(event) {
    ...
    if (event.isTrusted) {
      var ad_id = Number(event.target.closest('.inzercia').attributes["data-ad-id"].value);
...
function initializeForm(form) {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var businessElements = ['#row-business_name', '#row-business_address', '#row-business_id', '#row-business_tax_id', '#row-business_vat_id', '#row-business_request_confirmation'];
...
function postFilterModal() {
  var filterInstances = document.querySelectorAll(".post-filters");
  ...
  function closeModal(event) {
    var filterModal = event.target.closest('.filters-modal');
  ...
  document.addEventListener('keydown', function (event) {
    if (event.key === 'Escape') {
      if (document.body.classList.contains('modal-open')) {
        for (var _i = 0; _i < filterInstances.length; _i++) {
          filterInstances[_i].querySelector('.filters-modal').classList.remove('open');
          document.body.classList.remove('modal-open');
        }
      }
    }
  ...
  function toggleModal(event) {
    var filterModal = event.target.closest(".post-filters").querySelector('.filters-modal');
...
/* harmony import */ var _ad_inserter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ad-inserter */ "./assets/scripts/ad-inserter.js");
/* harmony import */ var _ajax_request__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ajax-request */ "./assets/scripts/ajax-request.js");
/* harmony import */ var _post_filter_modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./post-filter-modal */ "./assets/scripts/post-filter-modal.js");
/* harmony import */ var _show_more_posts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./show-more-posts */ "./assets/scripts/show-more-posts.js");
/* harmony import */ var _donation_form__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./donation-form */ "./assets/scripts/donation-form.js");
...
(0,_show_more_posts__WEBPACK_IMPORTED_MODULE_5__["default"])();
(0,_donation_form__WEBPACK_IMPORTED_MODULE_6__["default"])();
//console.log(site_info);
var isSinglePost = (0,_ad_inserter__WEBPACK_IMPORTED_MODULE_2__.checkSinglePost)();
(0,_post_filter_modal__WEBPACK_IMPORTED_MODULE_4__["default"])();

//adInserter();
if (isSinglePost) {
  if ((0,_ad_inserter__WEBPACK_IMPORTED_MODULE_2__.checkAdInsertingEnabledSinglePost)()) {
    (0,_ajax_request__WEBPACK_IMPORTED_MODULE_3__["default"])('adinserter', {
      single: true
    }, _ad_inserter__WEBPACK_IMPORTED_MODULE_2__.adInserter, [true, _ajax_request__WEBPACK_IMPORTED_MODULE_3__["default"]]);
  }
} else {
  (0,_ajax_request__WEBPACK_IMPORTED_MODULE_3__["default"])('adinserter', {
    single: false
  }, _ad_inserter__WEBPACK_IMPORTED_MODULE_2__.adInserter, [false, _ajax_request__WEBPACK_IMPORTED_MODULE_3__["default"]]);
}
...
if (topHeaderCollapsed) {
  topHeaderCollapse = new (bootstrap_js_dist_collapse__WEBPACK_IMPORTED_MODULE_0___default())(topHeader, {
    toggle: false
  });
}
...
addEventListener("DOMContentLoaded", function () {
  if (_typeof(postViewsElements) !== undefined) {
    ...
    for (var i = 0; i < postViewsElements.length; i += 8) {
      ...
      (0,_ajax_request__WEBPACK_IMPORTED_MODULE_3__["default"])('getviews', {
        ids: postIdsBatch
