...
function shareButton() {
  ...
  var copyLinkButton = document.querySelector('.post-share-button.link-share');
  var clipboardCopied = false; //wether to insert the success text on link copy
  ...
  copyLinkButton.addEventListener('click', function (event) {
    ...
    var copiedSuccessText = event.target.getAttribute('data-copied-text');
