...
/* harmony export */   "default": () => (/* binding */ adInserter)
/* harmony export */ });
function adInserter() {
  //check if is post
  if (document.body.classList.contains('single-post')) {
    ...
    var paragraphs = mainContainer.querySelectorAll(".post-content p");
...
(0,_ad_inserter__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
function showTopHeaderOnMousewheelUp(event) {
  ...
  if (delta =  true && topHeaderCollapsed) {
    topHeaderCollapse.show();
