...
function kapital_update_post_date_from_acf($post_id) {
...
add_action('acf/save_post', 'kapital_update_post_date_from_acf', 20);
...
function kapital_sortable_inzercia_custom_columns( $columns ) {
    ...
    $columns['ad_end_date'] = 'ad_start_date';
