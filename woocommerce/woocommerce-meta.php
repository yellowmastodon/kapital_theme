...
function kapital_product_repeater_meta_boxes() {
	add_meta_box( 'kapital-repeater-single-repeater-data', __('Dáta produktu', 'kapital'), 'kapital_repeater_single_repeatable_meta_box_callback', 'product', 'after_title', 'high' );
}
